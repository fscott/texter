...
public class LuceneTexterImpl implements Texter<IndexSearcher,Query>{
    ...
    @Override
    public void setFilesToProcess(final Path documentDir, boolean doPreProcess)
            throws FileNotFoundException, IOException {

        //IndexWriter iw = new IndexWriter(, null);
    }

    @Override
    public void process(List<String> searchTerms) {
